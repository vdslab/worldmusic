...
dbname = './data/musicvisdatabase.db'
...
if not cur.fetchone():
    cur.execute(
        'CREATE TABLE Country(countryid STRING primary key, country STRING, region STRING)'
    )
...
#print data
# print("Artist:")
# print(cur.execute("SELECT artist, artistid FROM Artist"))
# print(cur.fetchall())
# print("Country:")
# print(cur.execute("SELECT countryid, country, area FROM Country"))
# print(cur.fetchall())
# print("MusicArtist:")
# print(cur.execute("SELECT artistid, musicid FROM MusicArtist"))
# print(cur.fetchall())
# print("Music:")
# print(cur.execute("SELECT TYPEOF(musicid), TYPEOF(name), TYPEOF(acousticness), TYPEOF(danceability), TYPEOF(energy), TYPEOF(instrumentalness), TYPEOF(liveness), TYPEOF(loudness), TYPEOF(mode), TYPEOF(speechiness), TYPEOF(tempo), TYPEOF(time_signature), TYPEOF(valence) FROM Music"))
# print(cur.fetchall())
# print("Artist:")

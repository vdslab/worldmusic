...
const aboutFeatureAndData = () => {
  return (
    <div>
      ...
      <h2 className="title is-5">instrumentalnessとは？</h2>
      <p>
      ...
      <h2 className="title is-5">speechinessとは？</h2>
      <p>
      ...
      <h2 className="title is-5">tempoとは？</h2>
      <p>
        トラック全体で見込まれる毎分時のビート（BPM）。音楽用語では、テンポは特定の曲の速度またはペースを指し、ビートの持続時間の平均から導き出されるものである。
      </p>
      <h2 className="title is-5">time_signatureとは？</h2>
      <p>曲の長さを示す。</p>
      <h2 className="title is-5">valenceとは？</h2>
      <p>
